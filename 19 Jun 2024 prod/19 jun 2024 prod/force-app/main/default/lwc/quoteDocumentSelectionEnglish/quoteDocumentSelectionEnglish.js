...
import { OMNIDEF } from './quoteDocumentSelectionEnglish_def.js';
import tmpl from './quoteDocumentSelectionEnglish.html';
import tmpl_nds from './quoteDocumentSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteDocumentSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
