...
export default class FileUploadREComponent extends LightningElement {
    //send data to flow
    @api fileData
    @api uniqueId;
    ...
    // }
    get acceptedFormats() {
        const excludedExtensions = ['.exe', '.bat', '.com', '.cmd', '.inf', '.ipa', '.osx', '.pif', '.run', '.wsh', '.jpg', '.jpeg', '.gif', '.png'];
        const allExtensions = [
            ...
            '.jar', '.java', '.jpeg', '.jpg', '.js', '.json', '.key', '.kml', '.kmz', '.log', '.m4a', '.m4v', '.max', '.mdb', '.mobi',
            ...
            '.txt', '.vob', '.vsd', '.wav', '.webm', '.wma', '.wmv', '.wpd', '.wps', '.xcf', '.xls', '.xlsx', '.xml', '.xps', '.zip'
        ];
