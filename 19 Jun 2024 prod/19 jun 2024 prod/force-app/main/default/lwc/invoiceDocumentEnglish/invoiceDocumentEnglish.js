...
import { OMNIDEF } from './invoiceDocumentEnglish_def.js';
import tmpl from './invoiceDocumentEnglish.html';
import tmpl_nds from './invoiceDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class invoiceDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
