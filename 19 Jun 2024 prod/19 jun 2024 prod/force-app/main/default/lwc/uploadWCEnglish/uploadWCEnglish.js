...
import { OMNIDEF } from './uploadWCEnglish_def.js';
import tmpl from './uploadWCEnglish.html';
import tmpl_nds from './uploadWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class uploadWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
