...
import { OMNIDEF } from './quotePolicyReassignmentEnglish_def.js';
import tmpl from './quotePolicyReassignmentEnglish.html';
import tmpl_nds from './quotePolicyReassignmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quotePolicyReassignmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
