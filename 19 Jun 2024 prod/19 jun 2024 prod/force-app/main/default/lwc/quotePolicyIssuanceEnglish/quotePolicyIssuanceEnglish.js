...
import { OMNIDEF } from './quotePolicyIssuanceEnglish_def.js';
import tmpl from './quotePolicyIssuanceEnglish.html';
import tmpl_nds from './quotePolicyIssuanceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quotePolicyIssuanceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
