...
import { OMNIDEF } from './fCUploadExcelEnglish_def.js';
import tmpl from './fCUploadExcelEnglish.html';
import tmpl_nds from './fCUploadExcelEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fCUploadExcelEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
