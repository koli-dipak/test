...
import { OMNIDEF } from './quoteBinderAddSubjectivityEnglish_def.js';
import tmpl from './quoteBinderAddSubjectivityEnglish.html';
import tmpl_nds from './quoteBinderAddSubjectivityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteBinderAddSubjectivityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
