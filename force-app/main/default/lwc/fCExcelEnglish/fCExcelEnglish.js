...
import { OMNIDEF } from './fCExcelEnglish_def.js';
import tmpl from './fCExcelEnglish.html';
import tmpl_nds from './fCExcelEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fCExcelEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
