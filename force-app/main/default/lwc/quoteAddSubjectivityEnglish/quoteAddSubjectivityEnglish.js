...
import { OMNIDEF } from './quoteAddSubjectivityEnglish_def.js';
import tmpl from './quoteAddSubjectivityEnglish.html';
import tmpl_nds from './quoteAddSubjectivityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteAddSubjectivityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
