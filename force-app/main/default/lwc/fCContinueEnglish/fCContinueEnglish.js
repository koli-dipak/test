...
import { OMNIDEF } from './fCContinueEnglish_def.js';
import tmpl from './fCContinueEnglish.html';
import tmpl_nds from './fCContinueEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fCContinueEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
