...
import { OMNIDEF } from './quoteGenerateDocumentEnglish_def.js';
import tmpl from './quoteGenerateDocumentEnglish.html';
import tmpl_nds from './quoteGenerateDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteGenerateDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
