...
import { OMNIDEF } from './quoteWordtopdfEnglish_def.js';
import tmpl from './quoteWordtopdfEnglish.html';
import tmpl_nds from './quoteWordtopdfEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteWordtopdfEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
