...
import { OMNIDEF } from './quoteDocumentBinderEnglish_def.js';
import tmpl from './quoteDocumentBinderEnglish.html';
import tmpl_nds from './quoteDocumentBinderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class quoteDocumentBinderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
