import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfFcuploadapplication_5_N2G extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`fcuploadapplication`,this._allMergeFields,this._regexPattern,"noparse");
